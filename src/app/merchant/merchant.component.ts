...
export class MerchantComponent {
  products: Product[] = [
    { name: '18500 Unisex Heavy Blend Hooded Sweatshirt',
      price: 39,
      images: ['assets/sweatshirt1.png', 'assets/sweatshirt2.png', 'assets/sweatshirt3.png'],
      activeImageIndex: 0,
    ...
    price: 9, images: [ 'assets/stickers1.png'],
      activeImageIndex: 0, description: `Add some sparkle to your life with these holographic stickers. Made from high-quality vinyl, they’re easy to peel and stick, and their adhesive backing ensures long-lasting durability. The unique holographic effect catches the light in a mesmerizing way, making them the ultimate eye-catcher.
    ...
    price: 9, images: [ 'assets/stickers3.png'],
      activeImageIndex: 0,description: `Add some sparkle to your life with these holographic stickers. Made from high-quality vinyl, they’re easy to peel and stick, and their adhesive backing ensures long-lasting durability. The unique holographic effect catches the light in a mesmerizing way, making them the ultimate eye-catcher.
    ...
    price: 9, images: [ 'assets/stickers4.png'],
      activeImageIndex: 0, description: `Add some sparkle to your life with these holographic stickers. Made from high-quality vinyl, they’re easy to peel and stick, and their adhesive backing ensures long-lasting durability. The unique holographic effect catches the light in a mesmerizing way, making them the ultimate eye-catcher.
    ...
    {name: 'iPhone Case',
      price: 16,
      images: ['assets/iphone_case2.png'],
      activeImageIndex: 0,
  ...
  Important: The iPhone 15 series can’t be shipped to South Korea, Hong Kong, Taiwan, Japan, or Singapore. If your shipping address is in these regions, please choose a different iPhone model.`,
    ...
    { name: 'Snap Case for iPhone®',
      price: 16,
      images: ['assets/iphone_case1.png'],
      activeImageIndex: 0,
    ...
    { name: 'Yupoong 6245CM - Unstructured Classic Dad Cap',
        price: 28,
        images: ['assets/cap1.png', 'assets/cap2.png', 'assets/cap3.png', 'assets/cap4.png', 'assets/cap5.png', 'assets/cap6.png', 'assets/cap7.png', 'assets/cap8.png'],
        activeImageIndex: 0,
        ...
        },
    {
        ...
        • Blank product sourced from the US and Sweden`,
          ...
          },
          {
            ...
            price: 19,
            images: ['assets/notebook2.png', 'assets/notebook3.png'],
            activeImageIndex: 0,
        ...
        • Expandable inner pocket`,
          ...
          },
          {
            ...
            "price": 39,
            "images": ["assets/shorts1.png", "assets/shorts2.png", "assets/shorts3.png"],
            "activeImageIndex": 0,
        ...
        },
        {
            "name": "GDS101",
            "price": 80,
            "images": ["assets/gds101.png", "assets/gds102.png", "assets/gds103.png", "assets/gds104.png"],
            "activeImageIndex": 0,
        ...
        },
        {
            "name": "My Snapback",
            "price": 29,
            "images": ["assets/snapback1.png", "assets/snapback2.png", "assets/snapback3.png", "assets/snapback4.png", "assets/snapback5.png", "assets/snapback6.png", "assets/snapback7.png", "assets/snapback8.png"],
            "activeImageIndex": 0,
          ...
          },
          {
            name: 'My Mug',
            price: 18,
            images: ['assets/mug1.png','assets/mug2.png','assets/mug3.png',],
            activeImageIndex: 0,
          ...
          },
          {
            ...
            price: 36,
            images: ['assets/sweatshirt4.png', 'assets/sweatshirt5.png', 'assets/sweatshirt6.png' ,' assets/sweatshirt7.png','assets/sweatshirt8.png','assets/sweatshirt9.png','assets/sweatshirt10.png','assets/sweatshirt11.png'],
            activeImageIndex: 0,
            description: `Everyone needs a cozy go-to hoodie to curl up in, so go for one that's soft, smooth, and stylish. It's the perfect choice for cooler evenings!
